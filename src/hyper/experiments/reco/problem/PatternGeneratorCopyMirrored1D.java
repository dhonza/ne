 ...
 */
public class PatternGeneratorCopyMirrored1D implements PatternGenerator {
    final private double[][] inputPatterns;
    final private double[][] outputPatterns;

    public PatternGeneratorCopyMirrored1D(ParameterCombination parameters) {
        inputPatterns = PatternUtils.generateAllPatterns(parameters.getInteger("RECO.LINE_SIZE"));
        outputPatterns = PatternUtils.generateAllPatternsMirrored(parameters.getInteger("RECO.LINE_SIZE"));
    }
