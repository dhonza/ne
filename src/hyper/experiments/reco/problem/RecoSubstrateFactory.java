...
public class RecoSubstrateFactory {
    ...
    public static BasicSubstrate createInputToOutput(int inputNodes, int outputNodes) {
        ...
        SubstrateLayer biasLayer = new BiasLayer1D(0.0);
        SubstrateLayer inputLayer = new LineLayer1D(NodeType.INPUT, inputNodes, -2.0, 1.0);
        SubstrateLayer outputLayer = new LineLayer1D(NodeType.OUTPUT, outputNodes, -2.0, 1.0);
    ...
    public static BasicSubstrate createInputHiddenOutput(int inputNodes, int hiddenNodes, int outputNodes) {
        ...
        SubstrateLayer biasLayer = new BiasLayer1D(0.0);
        SubstrateLayer inputLayer = new LineLayer1D(NodeType.INPUT, inputNodes, 1.0, 1.0);
