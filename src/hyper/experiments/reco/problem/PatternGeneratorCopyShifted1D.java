 ...
 */
public class PatternGeneratorCopyShifted1D implements PatternGenerator {
    final private double[][] inputPatterns;
    final private double[][] outputPatterns;

    public PatternGeneratorCopyShifted1D(ParameterCombination parameters) {
        inputPatterns = PatternUtils.generateAllPatterns(parameters.getInteger("RECO.LINE_SIZE"));
        outputPatterns = PatternUtils.generateShifted(inputPatterns, parameters.getInteger("RECO.SHIFT_BY"));
    }
