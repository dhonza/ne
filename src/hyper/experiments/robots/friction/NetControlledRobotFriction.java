...
public class NetControlledRobotFriction extends RobotWithSensors {
    ...
    public void setSensors(int howMany, double startingAngle, double angleIncrement, double frictionDistance) {
    ...
    public double[] getSensoryData() {
        ...
        for (Sensor sensor : sensors) {
            if (sensor instanceof SurfaceFrictionSensor) {
                ...
                data[si] = Util.rescale(v, 1, 10);   // should min and max friction in the arena
                si++;
            }
        }
        sensoryData = data;
