...
public abstract class LineSearchBrent extends LineSearch {
    ...
    // Brent's method
    protected double brentMaxIterations = 100;
    private double brentGoldRatio = 0.3819660;
    //    private double brentEpsilon = 1.0e-10;
    protected double brentEpsilon = 1.0E-15;

    public LineSearchBrent(ObjectiveFunction ofunc) {
        super(ofunc);
    }

    protected void minimumBracketing(double ox0[], double[] odir, double ofx0) throws LineSearchException {
