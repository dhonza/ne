...
public class ConjugateGradientMinimization extends MinimizationMethod {
    ...
    public ConjugateGradientMinimization(ObjectiveFunction ofunc, LineSearch olineSearch) {
    ...
    public ConjugateGradientMinimization(ObjectiveFunction ofunc, LineSearch olineSearch, final double otolerance, final Method omethod, final int omaxIterations, final boolean ousePlusMethod) {
        func = ofunc;
...
//            System.out.println("iteration = " + iteration);
            ...
            try {
                ...
                System.err.println("The data cen be vizualized wrongly");
...
//                System.out.println("fx = " + fx);
            ...
            orthoTest = Math.abs(MathUtil.dotProduct(g, gold)) / MathUtil.dotProduct(g, g);
