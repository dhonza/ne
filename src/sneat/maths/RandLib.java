...
public class RandLib {
    ...
    static public double gennor(double av, double sd) {
        if (sd < 0.0)
            throw new IllegalArgumentException("gennor() - invalid sd");
    ...
    static public double snorm() {
        System.out.println("RandLib.snorm might cause problems!");
        int i = 0;
        double snorm, u = 0.0, s = 0.0, ustar = 0.0, aa = 0.0, w = 0.0, y, tt = 0.0;
        ...
        throw new IllegalStateException("Never should visit this place :(.");
    }
