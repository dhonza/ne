...
public class RouletteWheel {
    ...
    /// <returns></returns>
    static public boolean singleThrow(double probability) {
    ...
    static public int singleThrowEven(int numberOfOutcomes) {
        ...
        throw new IllegalStateException("PeannutLib.Maths.singleThrowEven() - invalid outcome.");
    }
    ...
    static public int singleThrow(double[] probabilities) {
        ...
        throw new IllegalStateException("PeannutLib.Maths.singleThrow() - invalid outcome.");
    }
