...
public class NumericalDifferentiation {
     ...
     * @param ograd vector for gradientCD
     */
    public static void gradientFD(ObjectiveFunction ofunc, double[] oarg, double ofx, double[] ograd) {
     ...
     * @param ograd vector for gradientCD
     */
    public static void gradientFD(ObjectiveFunction ofunc, double[] oarg, double[] ograd) {
